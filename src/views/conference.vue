                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addDataModalLabel"><i class="bi bi-plus-circle-fill"></i> Add Conference</h5>
                            </div>
                        ...
                        <div class="faaa rounded h-100 p-1">
                            <div class="table-responsive rounded">
                                <table class="faaa1 table table-striped" style="background-color: #e3fbf2; color:">
                                    ...
                                    <tbody>
                                        <tr v-for="(conference, index) in paginatedConference" :key="conference.id">
                                            <th scope="row">{{ conference.id }}</th>
                                            <td>{{ conference.confName }}</td>
                                            <td>{{ conference.detailConf }}</td>
                                            <td><img :src="'assets/images/' + conference.confImages" alt="Conference Image" style="width: 50px; height: 70px;"></td>
                                            <td>
                            ...
                            <!-- End Pagination -->
                                 ...
                                 <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditDataModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        <h5 class="modal-title" id="EditDataModalLabel"><i class="bi bi-pencil"></i> Edit Conference</h5>
                                        </div>
                                        <div class="modal-body">
                                            <div class="row">
                                                <!-- Form Section -->
                                    ...
                                    <div class="modal fade" id="DeleteModal" tabindex="-1" aria-labelledby="DeleteDataModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="DeleteDataModalLabel"><i class="bi bi-trash"></i> Delete Conference</h5>
                                                </div>
                                                <div class="modal-body">
...
export default {
    ...
    computed: {
        ...
        const filteredResults = this.conference.filter(conference => {
            return (
                conference.id.toString().includes(searchQuery) ||
                conference.confName.toLowerCase().includes(searchQuery) ||
                conference.detailConf.toLowerCase().includes(searchQuery)
            );
        });
        ...
        totalPages() {
            return Math.ceil(this.conference.length / this.itemsPerPage);
        },
    },
...
methods: {
  ...
  mounted() {
    axios
      ...
      .then((response) => this.setConferencce(response.data))
